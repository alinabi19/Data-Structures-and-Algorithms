...
// 90 degree rotation
    ...
    reverseMat(arr, row, col); // rotate 90degree , // 1st and 3rd row (col by col) ko swap krdiya
// 180 degree rotation
    transpose(arr, row, col);  
    reverseMat(arr, row, col);  // rotate 180degree  , // 1st and 3rd row (col by col) ko swap krdiya
// 270 degree rotation
    transpose(arr, row, col);  
    reverseMat(arr, row, col);  // rotate 270 degree  , // 1st and 3rd row (col by col) ko swap krdiya
